...
## Overview
This document provides detailed information about the `captains/register` endpoint for registering a new captain in the system. It outlines the request structure, validation rules, and response format for the endpoint.
